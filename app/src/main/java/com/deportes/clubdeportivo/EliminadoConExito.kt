...
class EliminadoConExitoFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_eliminado_con_exito, container, false)
    ...
    companion object {
        const val TAG = "EliminadoConExitoFragment"
        fun newInstance(): EliminadoConExitoFragment {
            return EliminadoConExitoFragment()
        }
    }
}